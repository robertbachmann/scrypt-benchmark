package io.github.robertbachmann.scryptbenchmark.bcmod4;
...
public class SCrypt
{
    ...
    public static void salsaCore(int[] input, int[] x)
    {
        if (input.length != 16)
        {
