package io.github.robertbachmann.scryptbenchmark.bcmod3;
...
public class SCrypt
{
    ...
    public static void salsaCore(int rounds, int[] input, int[] output, int[] B, int BOff)
    {
        if (input.length != 16)
        {
        ...
        int x00 = input[ 0] = output[ 0] ^ B[BOff+0];
        int x01 = input[ 1] = output[ 1] ^ B[BOff+1];
        int x02 = input[ 2] = output[ 2] ^ B[BOff+2];
        int x03 = input[ 3] = output[ 3] ^ B[BOff+3];
        int x04 = input[ 4] = output[ 4] ^ B[BOff+4];
        int x05 = input[ 5] = output[ 5] ^ B[BOff+5];
        int x06 = input[ 6] = output[ 6] ^ B[BOff+6];
        int x07 = input[ 7] = output[ 7] ^ B[BOff+7];
        int x08 = input[ 8] = output[ 8] ^ B[BOff+8];
        int x09 = input[ 9] = output[ 9] ^ B[BOff+9];
        int x10 = input[10] = output[10] ^ B[BOff+10];
        int x11 = input[11] = output[11] ^ B[BOff+11];
        int x12 = input[12] = output[12] ^ B[BOff+12];
        int x13 = input[13] = output[13] ^ B[BOff+13];
        int x14 = input[14] = output[14] ^ B[BOff+14];
        int x15 = input[15] = output[15] ^ B[BOff+15];
